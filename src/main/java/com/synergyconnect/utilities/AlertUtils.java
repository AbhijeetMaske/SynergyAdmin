...
/********************************************************************************************
 * Utility class to handle interactions with JavaScript alerts in Selenium
 * WebDriver.
 * 
...
public class AlertUtils {
	...
	public boolean waitForToasterToDisappear(Duration timeoutInSeconds) {
	    try {
	        WebDriverWait wait = new WebDriverWait(driver, timeoutInSeconds);
	        return wait.until(ExpectedConditions.invisibilityOfElementLocated(By.className("toast-message")));
	    } catch (Exception e) {
	        logger.error("Toaster did not disappear within the timeout.", e);
	        return false;
	    }
	}
}